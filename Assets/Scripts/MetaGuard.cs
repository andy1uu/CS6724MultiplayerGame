...
public class MetaGuard : MonoBehaviour {
    ...
    public float height;
    public float arm_length_ratio;
    public float wingspan;
    public float squat_depth;
    public float ipd;
    ...
    public List<float> height_noises = new List<float>();
    public List<float> right_arm_noises = new List<float>();
    public List<float> left_arm_noises = new List<float>();
    public List<float> wingspan_and_right_arm_noises = new List<float>();
    public List<float> wingspan_and_left_arm_noises = new List<float>();
    public List<float> wingspan_right_arm_noises = new List<float>();
    public List<float> wingspan_left_arm_noises = new List<float>();
    public List<float> squat_depth_noises = new List<float>();
    public List<float> room_width_noises = new List<float>();
    public List<float> room_length_noises = new List<float>();
    public List<float> ipd_noises = new List<float>();
    public List<bool> handedness_rand = new List<bool>();

    // DP bounds for each attribute
    public float room_lower = 0f;
    public float room_upper = 5f;
    public float room_sensitivity;
    public float height_lower = 1.496f;
    public float height_upper = 1.826f;
    public float height_sensitivity;
    public float squat_depth_lower = 0f;
    public float squat_depth_upper;
    public float squat_depth_sensitivity;
    public float arm_ratio_lower = 0.95f;
    public float arm_ratio_upper = 1.05f;
    public float arm_ratio_sensitivity;
    public float wingspan_lower;
    public float wingspan_upper;
    public float wingspan_sensitivity;
    public float arm_length_lower = 0.663f;
    public float arm_length_upper = 0.853f;
    public float arm_length_sensitivity;
    public float ipd_lower = 0.0557f;
    public float ipd_upper = 0.0710f;
    public float ipd_sensitivity;

    // Toggle values for each attribute, true = protection off for some reason :D
    public bool height_toggle = true;
    public bool voice_toggle = true;
    public bool room_toggle = true;
    public bool ipd_toggle = true;
    public bool squat_depth_toggle = true;
    public bool wingspan_toggle = true;
    public bool arm_toggle = true;
    public bool handedness_toggle = true;
    ...
    void Update() {
        height_toggle = !( UI.heightToggle);
        arm_toggle = !( UI.armLengthsToggle);
        wingspan_toggle = !( UI.wingspanToggle);
        squat_depth_toggle = !( UI.squatDepthToggle);
        ipd_toggle = !( UI.ipdToggle);
        handedness_toggle = !( UI.handednessToggle);
